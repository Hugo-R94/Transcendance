  ...
  return (
	...
	<div className="relative min-h-screen">
		...
		<a href="http://localhost:5173/login">
			...
			<input id="password" type="password" className="balatro hover:outline-2 hover:outline-white z-15 bg-[#fb4740] focus:bg-[#ff3830] focus:scale-105  w-full h-15 mb-5 rounded-2xl p-2 outline-0 active:scale-90   shadow-md shadow-black text-gray-700" placeholder="Confirm your password ...">

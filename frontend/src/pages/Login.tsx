...
function Login() {
  ...
  return (
	...
	<div className="relative min-h-screen">
		...
		<form onSubmit={handleSubmit} className="absolute  flex flex-col w-70 h-100 bg-[#334b4d] rounded-2xl p-3 focus:shadow-2xl shadow-lg shadow-black outline-10 outline-gray-300  transition"> 
		...
		<a href="http://localhost:5173/signin">
			...
			<input onChange={(e) => setUsername(e.target.value)} value={username} className="balatro z-15 bg-[#ed8a00] hover:outline-2 hover:outline-white focus:bg-[#ffaa00] focus:scale-105  w-full h-15  mb-5 rounded-2xl p-2 outline-0 shadow-md shadow-black active:scale-90  text-gray-700" placeholder="Enter your email ...">

			</input>

			<input onChange={(e) => setPassword(e.target.value)} value={password}  type="password" className="balatro hover:outline-2 hover:outline-white z-15 bg-[#fb4740] focus:bg-[#ff3830] focus:scale-105  w-full h-15 mb-5 rounded-2xl p-2 outline-0 active:scale-90   shadow-md shadow-black text-gray-700" placeholder="Enter your password ...">

  ...
  const handleServerMessage = (
    ...
    switch (data.type) {
      ...
      case "player_bet_placed": {
        /*
         * Message informatif pour les autres joueurs.
         */
      ...
      case "turn_resolved": {
        ...
        if (me) {
           ...
           * IMPORTANT :
           *
           * C'est ici que le solde final
           * du tour est synchronisé.
           */

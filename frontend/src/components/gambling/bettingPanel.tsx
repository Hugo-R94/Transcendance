    ...
    >
      ...
      >
        ...
        <div
          ...
          "
        >
          <div className="flex h-8 w-full justify-center sm:h-9 sm:w-80">
        ...
        {/* MONTANT / BOUTONS */}
        <div className="my-1 w-full px-2 sm:w-fit sm:px-0">
        ...
        {/* MISE ACTUELLE */}
        <div className="flex items-center justify-center gap-x-1 text-xs text-center sm:text-base">
          <p>Mise actuelle</p>

          <p className="mx-1 text-lg font-extrabold sm:mx-3 sm:text-xl">
            {betAmount}
          </p>

  ...
  return (
    ...
    >
      ...
      <svg
        viewBox="0 0 64 64"
        fill="currentColor"
        className={`object-fit balatro shrink-0 transition-colors duration-200 ${
          isActive ? "text-byellow" : "text-white"
        }`}
        xmlns="http://www.w3.org/2000/svg"
      >
        <g id="24_wishlist">
          {/* Lignes de la liste et cases à cocher */}
          ...
          {/* Cœur rempli ou contour selon isActive */}
          {isActive ? (
            ...
            <path d="M49.52,46.61c-.01-.11-.03-.21-.05-.32a3.519,3.519,0,0,0-3.48-2.94h-.02a5,5,0,0,0-3.42,1.46,4.963,4.963,0,0,0-3.42-1.46h-.01a3.326,3.326,0,0,0-.96.15.749.749,0,0,0-.16.04,3.5,3.5,0,0,0-2.01,1.73c-.01.03-.02.05-.03.08a3.682,3.682,0,0,0-.33.95c-.02.1-.03.2-.05.31-.65,4.9,4.37,8.58,5.89,9.57l.51.35a.931.931,0,0,0,.57.19.959.959,0,0,0,.58-.19l.47-.33C45.15,55.19,50.17,51.51,49.52,46.61ZM42.55,54.5c-2.67-1.76-5.38-4.67-4.98-7.63l.03-.21a1.526,1.526,0,0,1,1.52-1.31,3.026,3.026,0,0,1,2.54,1.58,1.039,1.039,0,0,1,1.78,0,3.039,3.039,0,0,1,2.54-1.58,1.518,1.518,0,0,1,1.52,1.3l.04.22C47.93,49.82,45.25,52.72,42.55,54.5Z" />
          )}
        </g>
      </svg>
    </button>
...
export default WishlistGameButton;